...
function chartSlide(pptx,c,state){const s=base(pptx,'نمودار');title(s,pptx,c.title,c.id,c.subtitle);const series=chartSeries(c);const kind=c.type==='line'?pptx.ChartType.line:c.type==='donut'?pptx.ChartType.doughnut:pptx.ChartType.bar;
